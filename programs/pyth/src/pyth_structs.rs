...
pub struct Price {
    ...
    pub prod: AccountKey,          // Product account key.
    pub next: AccountKey,          // Next Price account in linked list.
    pub agg_pub: AccountKey,       // Quoter who computed last aggregate price.
