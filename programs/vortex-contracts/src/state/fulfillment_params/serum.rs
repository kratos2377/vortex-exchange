...
use crate::utils::serum_utils::{calculate_price_from_serum_limit_price, calculate_serum_limit_price, calculate_serum_max_coin_qty, calculate_serum_max_native_pc_quantity};
...
impl<'a, 'b> SerumContext<'a, 'b> {
    ...
    pub fn to_serum_v3_fulfillment_config(
        ...
        market_index: u16,
    ) -> VortexDexResult<SerumV3FulfillmentConfig> {
...
impl<'a, 'b> SerumFulfillmentParams<'a, 'b> {
    ...
    pub fn invoke_settle_funds(&self) -> VortexDexResult {
