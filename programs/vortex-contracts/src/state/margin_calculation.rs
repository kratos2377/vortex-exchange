...
use crate::{casting::Cast, errors::{DexError, VortexDexResult}, safe_methods::SafeMath, utils::{constants::MARGIN_PRECISION_U128, fuel_utils::calculate_spot_fuel_bonus, margin_utils::MarginRequirementType, spot_market_utils::get_strict_token_value}, validate};
...
impl MarginContext {
    ...
    pub fn track_open_orders_fraction(mut self) -> VortexDexResult<Self> {
        match self.mode {
            ...
            _ => {
                ...
                return Err(DexError::InvalidMarginCalculation);
            }
        }
        Ok(self)
    }
...
impl MarginCalculation {
    ...
    pub fn add_total_collateral(&mut self, total_collateral: i128) -> VortexDexResult {
    ...
    pub fn add_open_orders_margin_requirement(&mut self, margin_requirement: u128) -> VortexDexResult {
    ...
    pub fn add_spot_liability(&mut self) -> VortexDexResult {
    ...
    #[cfg(feature = "vortex-rs")]
    pub fn add_spot_liability_value(&mut self, spot_liability_value: u128) -> VortexDexResult {
    ...
    pub fn positions_meets_margin_requirement(&self) -> VortexDexResult<bool> {
    ...
    pub fn can_exit_liquidation(&self) -> VortexDexResult<bool> {
    ...
    pub fn margin_shortage(&self) -> VortexDexResult<u128> {
        if self.context.margin_buffer == 0 {
    ...
    pub fn tracked_market_margin_shortage(&self, margin_shortage: u128) -> VortexDexResult<u128> {
    ...
    pub fn get_free_collateral(&self) -> VortexDexResult<u128> {
