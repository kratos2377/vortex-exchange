...
impl SpotMarket {
    ...
    pub fn get_max_confidence_interval_multiplier(&self) -> VortexDexResult<u64> {
    ...
    pub fn get_sanitize_clamp_denominator(&self) -> VortexDexResult<Option<i64>> {
        Ok(match self.asset_tier {
    ...
    pub fn get_scaled_initial_asset_weight(&self, oracle_price: i64) -> VortexDexResult<u32> {
    ...
    pub fn get_deposits(&self) -> VortexDexResult<u128> {
        get_token_amount(self.deposit_balance, self, &SpotBalanceType::Deposit)
    }

    pub fn get_borrows(&self) -> VortexDexResult<u128> {
    ...
    pub fn get_available_deposits(&self) -> VortexDexResult<u128> {
    ...
    pub fn get_utilization(self) -> VortexDexResult<u128> {
        let deposit_token_amount =
            get_token_amount(self.deposit_balance, &self, &SpotBalanceType::Deposit)?;
    ...
    pub fn is_healthy_utilization(self) -> VortexDexResult<bool> {
    ...
    pub fn get_min_borrow_rate(self) -> VortexDexResult<u32> {
