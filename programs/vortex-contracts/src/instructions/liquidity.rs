...
pub fn handle_add_liquidity(
    ...
    require!(amount_liq0 <= user_balance0, DexError::NotEnoughBalance);
    require!(amount_liq1 <= user_balance1, DexError::NotEnoughBalance);
    ...
    if vault_balance0 == 0 && vault_balance1 == 0 {
        ...
        require!(amount_deposit_1 <= amount_liq1, DexError::NotEnoughBalance);
    ...
    // saftey checks 
    require!(amount_to_mint > 0, DexError::NoPoolMintOutput);
